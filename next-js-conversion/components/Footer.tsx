      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold text-gray-800">MediSage AI</span>
            </div>
            <p className="text-gray-600 text-sm">
              Your AI-powered medical assistant for intelligent healthcare support.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/medical-chat" className="text-gray-600 hover:text-primary text-sm">
                  Medical Chat
                </Link>
              </li>
              <li>
                <Link href="/symptom-checker" className="text-gray-600 hover:text-primary text-sm">
                  Symptom Checker
                </Link>
              </li>
              <li>
                <Link href="/medicine-scanner" className="text-gray-600 hover:text-primary text-sm">
                  Medicine Scanner
                </Link>
              </li>
              <li>
                <Link href="/voice-assistant" className="text-gray-600 hover:text-primary text-sm">
                  Voice Assistant
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/disclaimer" className="text-gray-600 hover:text-primary text-sm">
                  Medical Disclaimer
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © {currentYear} MediSage AI. All rights reserved.
            </p>
